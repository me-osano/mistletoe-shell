;;; mistletoe-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme mistletoe "Theme using Template variables with quality of life improvements.")
