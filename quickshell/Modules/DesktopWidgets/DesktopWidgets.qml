...
Variants {
  ...
  delegate: Loader {
    ...
    active: modelData && Settings.data.desktopWidgets.enabled && (screenWidgets.length > 0 || DesktopWidgetRegistry.editMode) && (!CompositorService.overviewActive || Settings.data.desktopWidgets.overviewEnabled) && !PowerProfileService.mistletoePerformanceMode && !PanelService.lockScreen?.active
    ...
    sourceComponent: PanelWindow {
      ...
      WlrLayershell.namespace: "mistletoe-desktop-widgets-" + (screen?.name || "unknown")
