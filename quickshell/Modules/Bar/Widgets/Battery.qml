  ...
  function openBatteryPanel() {
    ...
    if (panel) {
      panel.panelID = {
        ...
        showMistletoePerformance: widgetSettings.showMistletoePerformance !== undefined ? widgetSettings.showMistletoePerformance : widgetMetadata.showMistletoePerformance
      };
      panel.toggle(root);
    }
  }
