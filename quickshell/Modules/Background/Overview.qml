...
Loader {
  ...
  sourceComponent: Variants {
    ...
    delegate: PanelWindow {
      ...
      WlrLayershell.namespace: "mistletoe-overview-" + (screen?.name || "unknown")
      ...
      Image {
        ...
        layer.effect: MultiEffect {
          blurEnabled: !PowerProfileService.mistletoePerformanceMode && (Settings.data.wallpaper.overviewBlur > 0)
