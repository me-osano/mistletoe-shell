...
Popup {
  ...
  TextMetrics {
    ...
    text: "Managed via MISTLETOE_WALLHAVEN_API_KEY environment variable."
  ...
  contentItem: ColumnLayout {
    ...
    ColumnLayout {
      ...
      NTextInput {
        ...
        placeholderText: WallhavenService.apiKeyManagedByEnv ? "Managed via MISTLETOE_WALLHAVEN_API_KEY environment variable." : "Enter your Wallhaven API Key"
