...
SmartPanel {
  ...
  panelContent: Item {
    ...
    readonly property bool showMistletoePerformance: panelID ? panelID.showMistletoePerformance : resolveWidgetSetting("showMistletoePerformance", false)
    ...
    ColumnLayout {
      ...
      NBox {
        ...
        visible: showPowerProfiles || showMistletoePerformance
        ...
        ColumnLayout {
          ...
          NDivider {
            Layout.fillWidth: true
            visible: showPowerProfiles && PowerProfileService.available && showMistletoePerformance
          }

          RowLayout {
            Layout.fillWidth: true
            spacing: Style.marginS
            visible: showMistletoePerformance

            NText {
              text: "Mistletoe Performance"
            ...
            NIcon {
              ...
              pointSize: Style.fontSizeL
              color: PowerProfileService.mistletoePerformanceMode ? Color.mPrimary : Color.mOnSurfaceVariant
            }

            NToggle {
              checked: PowerProfileService.mistletoePerformanceMode
              onToggled: checked => PowerProfileService.mistletoePerformanceMode = checked
            }
          }
        }
      }
