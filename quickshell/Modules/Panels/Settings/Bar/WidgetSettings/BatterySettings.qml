...
ColumnLayout {
  ...
  property bool valueShowMistletoePerformance: widgetData.showMistletoePerformance !== undefined ? widgetData.showMistletoePerformance : widgetMetadata.showMistletoePerformance
  ...
  function saveSettings() {
    ...
    settings.showMistletoePerformance = valueShowMistletoePerformance;
  ...
  NToggle {
    label: "Show Mistletoe Performance toggle"
    description: "Display the Mistletoe Performance Mode toggle inside the battery panel.<br>Disables shadows and animations in Mistletoe to reduce resource usage."
    checked: valueShowMistletoePerformance
    onToggled: checked => {
                 valueShowMistletoePerformance = checked;
                 saveSettings();
               }
  }
}
