...
ColumnLayout {
  ...
  NTextInput {
    ...
    description: "Unique identifier for IPC commands. Use this identifier with 'qs -c mistletoe-shell ipc call cb [action] [identifier]' to control this button via IPC."
