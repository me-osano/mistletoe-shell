...
ColumnLayout {
  ...
  // Startup Hook
  HookRow {
    label: "Mistletoe Started"
    description: "Command to execute when Mistletoe has finished loading."
    value: Settings.data.hooks.startup
    onEditClicked: openEdit(label, description, "e.g. notify-send 'Mistletoe Loaded'", value, newValue => {
  ...
  HookRow {
    ...
    description: "Command to be executed when Mistletoe Performance Mode is enabled."
  ...
  HookRow {
    ...
    description: "Command to be executed when Mistletoe Performance Mode is disabled."
