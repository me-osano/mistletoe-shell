...
Singleton {
  ...
  /*
  Shell directories.
  - Default config directory: ~/.config/mistletoe
  - Default cache directory: ~/.cache/mistletoe
  */
  readonly property alias data: adapter  // Used to access via Settings.data.xxx.yyy
  readonly property int settingsVersion: 53
  property bool isDebug: Quickshell.env("MISTLETOE_DEBUG") === "1"
  readonly property string shellName: "mistletoe"
  readonly property string configDir: Quickshell.env("MISTLETOE_CONFIG_DIR") || (Quickshell.env("XDG_CONFIG_HOME") || Quickshell.env("HOME") + "/.config") + "/" + shellName + "/"
  readonly property string cacheDir: Quickshell.env("MISTLETOE_CACHE_DIR") || (Quickshell.env("XDG_CACHE_HOME") || Quickshell.env("HOME") + "/.cache") + "/" + shellName + "/"
  readonly property string settingsFile: Quickshell.env("MISTLETOE_SETTINGS_FILE") || (configDir + "settings.json")
  ...
  JsonAdapter {
    ...
    property JsonObject colorSchemes: JsonObject {
      ...
      property string predefinedScheme: "Mistletoe (default)"
