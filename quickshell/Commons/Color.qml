...
/*
Mistletoe is not strictly a Material Design project, it supports both some predefined
...
Singleton {
  ...
  // --------------------------------
  // Default colors: Mistletoe (default) dark — must match Assets/ColorScheme/Mistletoe-default
  QtObject {
    id: defaultColors
