...
Singleton {
  ...
  function getBasename(path) {
    ...
    if (schemeName === "Mistletoe-default") {
      return "Mistletoe (default)";
    } else if (schemeName === "Mistletoe-legacy") {
      return "Mistletoe (legacy)";
  ...
  function resolveSchemePath(nameOrPath) {
    ...
    // Handle special cases for Mistletoe schemes
    var schemeName = nameOrPath.replace(".json", "");
    if (schemeName === "Mistletoe (default)") {
      schemeName = "Mistletoe-default";
    } else if (schemeName === "Mistletoe (legacy)") {
      schemeName = "Mistletoe-legacy";
    } else if (schemeName === "Tokyo Night") {
