...
Singleton {
  ...
  readonly property string mistletoeDefaultWallpaper: Quickshell.shellDir + "/Assets/Wallpaper/mistletoe.png"
  property string defaultWallpaper: mistletoeDefaultWallpaper
  ...
  FileView {
    ...
    adapter: JsonAdapter {
      ...
      property string defaultWallpaper: root.mistletoeDefaultWallpaper
      property var usedRandomWallpapers: ({})
    }
    ...
    onLoaded: {
      ...
      // Load default wallpaper from cache if it exists, otherwise use Mistletoe default
      if (wallpaperCacheAdapter.defaultWallpaper && wallpaperCacheAdapter.defaultWallpaper !== "") {
        ...
        root.defaultWallpaper = root.mistletoeDefaultWallpaper;
        Logger.d("Wallpaper", "Using Mistletoe default wallpaper");
      }
