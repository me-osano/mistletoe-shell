...
Singleton {
  ...
  IpcHandler {
    ...
    function toggleMistletoePerformance() {
      PowerProfileService.toggleMistletoePerformance();
    }

    function enableMistletoePerformance() {
      PowerProfileService.setMistletoePerformance(true);
    }

    function disableMistletoePerformance() {
      PowerProfileService.setMistletoePerformance(false);
    }
  }
