...
Singleton {
  ...
  Connections {
    ...
    function onMistletoePerformanceModeChanged() {
      const isEnabled = PowerProfileService.mistletoePerformanceMode;
  ...
  function init() {
    ...
    Qt.callLater(() => {
                   ...
                   wasPerformanceModeEnabled = PowerProfileService.mistletoePerformanceMode;
                   // Execute startup hook
                   executeStartupHook();
                 });
  }
